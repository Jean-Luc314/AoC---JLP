# Functions
function clean_whitespace(string::String)::String
    not_white(string::String)::Bool = string ∉ [" ", "\r", "\n"]
    string |> x -> split(x, "") .|> String |> x -> filter(not_white, x) |> prod
end
function count_code_chars(santas_list::String)::Int
    santas_list |> length
end
macro R_str(s)
    s
...
# Read
santas_list = read("2015/Input/Day 08.txt", String) |> clean_whitespace
# Part 1
char_length = santas_list |> count_code_chars
code_length = R"""
"qxfcsmh"
